...
namespace Advertise.ServiceLayer.Contracts.Users
{
    ...
    public interface IUserService : IBaseService, IDisposable
    {
        ...
        /// <returns></returns>
        Task<UserViewModel> EditUser(UserEditViewModel viewModel);
        ...
        /// <param name="viewModel"></param>
        /// <returns></returns>
        Task<UserViewModel> AddUser(UserCreateViewModel viewModel);
        ...
        /// <param name="viewModel"></param>
        /// <returns></returns>
        Task FillForEdit(UserEditViewModel viewModel);

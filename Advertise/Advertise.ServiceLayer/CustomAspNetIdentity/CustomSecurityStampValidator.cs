...
namespace Advertise.ServiceLayer.CustomAspNetIdentity
{
    ...
    public static class CustomSecurityStampValidator
    {
        ...
        public static Func<CookieValidateIdentityContext, Task> OnValidateIdentity(
            TimeSpan validateInterval, Func<UserService, User, Task<ClaimsIdentity>> regenerateIdentity)
        {
        ...
        /// <returns></returns>
        public static Func<CookieValidateIdentityContext, Task> OnValidateIdentity(
            TimeSpan validateInterval, Func<UserService, User, Task<ClaimsIdentity>> regenerateIdentityCallback,

    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        RoleAction_ReportCount = c.Int(nullable: false),
                        RoleAction_Version = c.Int(nullable: false),
                        RoleAction_Action = c.Int(nullable: false),
                        RoleAction_ModifiedById = c.Guid(nullable: false),
                        RoleAction_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.RoleAction_Id)
                .ForeignKey("dbo.AD_Users", t => t.RoleAction_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.RoleAction_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        User_IsBanned = c.Boolean(nullable: false),
                        User_BannedReason = c.String(),
                        User_BannedOn = c.DateTime(),
                        User_IsVerified = c.Boolean(nullable: false),
                        ...
                        User_MobileConfirmationToken = c.String(nullable: false, maxLength: 200),
                        ...
                        User_PasswordHash = c.String(nullable: false, maxLength: 200),
                ...
                c => new
                    {
                        ...
                        UserBudget_ReportCount = c.Int(nullable: false),
                        UserBudget_Version = c.Int(nullable: false),
                        UserBudget_Action = c.Int(nullable: false),
                        UserBudget_ModifiedById = c.Guid(nullable: false),
                        UserBudget_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.UserBudget_Id)
                .ForeignKey("dbo.AD_Users", t => t.UserBudget_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.UserBudget_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        FeatureOrder_ReportCount = c.Int(nullable: false),
                        FeatureOrder_Version = c.Int(nullable: false),
                        FeatureOrder_Action = c.Int(nullable: false),
                        FeatureOrder_ModifiedById = c.Guid(nullable: false),
                        FeatureOrder_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.FeatureOrder_Id)
                .ForeignKey("dbo.AD_Users", t => t.FeatureOrder_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Features", t => t.FeatureOrder_FeatureId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.FeatureOrder_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Feature_Code = c.String(nullable: false, maxLength: 50),
                        Feature_Title = c.String(nullable: false, maxLength: 100),
                        Feature_Description = c.String(maxLength: 250),
                        Feature_DurationDay = c.String(nullable: false),
                        ...
                        Feature_ReportCount = c.Int(nullable: false),
                        Feature_Version = c.Int(nullable: false),
                        Feature_Action = c.Int(nullable: false),
                        Feature_ModifiedById = c.Guid(nullable: false),
                        Feature_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Feature_Id)
                .ForeignKey("dbo.AD_Users", t => t.Feature_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Feature_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        TagOrder_ReportCount = c.Int(nullable: false),
                        TagOrder_Version = c.Int(nullable: false),
                        TagOrder_Action = c.Int(nullable: false),
                        TagOrder_ModifiedById = c.Guid(nullable: false),
                        TagOrder_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.TagOrder_Id)
                .ForeignKey("dbo.AD_Users", t => t.TagOrder_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.TagOrder_ModifiedById, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Product_ReportCount = c.Int(nullable: false),
                        Product_Version = c.Int(nullable: false),
                        Product_Action = c.Int(nullable: false),
                        Product_ModifiedById = c.Guid(nullable: false),
                        Product_CreatedById = c.Guid(nullable: false),
                        Review_Id = c.Guid(),
                        User_Id = c.Guid(),
                    })
                ...
                .ForeignKey("dbo.AD_Users", t => t.Product_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Product_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Address_ReportCount = c.Int(nullable: false),
                        Address_Version = c.Int(nullable: false),
                        Address_Action = c.Int(nullable: false),
                        Address_ModifiedById = c.Guid(nullable: false),
                        Address_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Address_Id)
                .ForeignKey("dbo.AD_Cities", t => t.Address_CityId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Address_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Address_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        City_ReportCount = c.Int(nullable: false),
                        City_Version = c.Int(nullable: false),
                        City_Action = c.Int(nullable: false),
                        City_ModifiedById = c.Guid(nullable: false),
                        City_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.City_Id)
                .ForeignKey("dbo.AD_Cities", t => t.City_ParentId)
                .ForeignKey("dbo.AD_Users", t => t.City_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.City_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Category_RowVersion = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"),
                        ...
                        Category_ReportCount = c.Int(nullable: false),
                        Category_Version = c.Int(nullable: false),
                        Category_Action = c.Int(nullable: false),
                        Category_ModifiedById = c.Guid(nullable: false),
                        Category_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Category_Id)
                .ForeignKey("dbo.AD_Categories", t => t.Category_ParentId)
                .ForeignKey("dbo.AD_Users", t => t.Category_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Category_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Company_Code = c.String(nullable: false, maxLength: 75),
                        Company_BrandName = c.String(nullable: false, maxLength: 200),
                        Company_Description = c.String(nullable: false),
                        Company_LogoFileName = c.String(maxLength: 75),
                        Company_BackgroundFileName = c.String(maxLength: 75),
                        Company_PhoneNumber = c.String(nullable: false, maxLength: 50),
                        Company_MobileNumber = c.String(nullable: false, maxLength: 11),
                        ...
                        Company_ReportCount = c.Int(nullable: false),
                        Company_Version = c.Int(nullable: false),
                        Company_Action = c.Int(nullable: false),
                        Company_ModifiedById = c.Guid(nullable: false),
                        Company_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.Company_Id)
                .ForeignKey("dbo.AD_Addresses", t => t.Company_AddressId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Company_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Company_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanyAttachment_ReportCount = c.Int(nullable: false),
                        CompanyAttachment_Version = c.Int(nullable: false),
                        CompanyAttachment_Action = c.Int(nullable: false),
                        CompanyAttachment_ModifiedById = c.Guid(nullable: false),
                        CompanyAttachment_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.CompanyAttachment_Id)
                .ForeignKey("dbo.AD_Companies", t => t.CompanyAttachment_CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyAttachment_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyAttachment_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanyFollow_ReportCount = c.Int(nullable: false),
                        CompanyFollow_Version = c.Int(nullable: false),
                        CompanyFollow_Action = c.Int(nullable: false),
                        CompanyFollow_ModifiedById = c.Guid(nullable: false),
                        CompanyFollow_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.CompanyFollow_Id)
                .ForeignKey("dbo.AD_Companies", t => t.CompanyFollow_CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyFollow_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyFollow_FollowedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyFollow_ModifiedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.User_Id)
                ...
                c => new
                    {
                        ...
                        CompanyImage_ReportCount = c.Int(nullable: false),
                        CompanyImage_Version = c.Int(nullable: false),
                        CompanyImage_Action = c.Int(nullable: false),
                        CompanyImage_ModifiedById = c.Guid(nullable: false),
                        CompanyImage_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.CompanyImage_Id)
                .ForeignKey("dbo.AD_Companies", t => t.CompanyImage_CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyImage_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyImage_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanyModerator_ReportCount = c.Int(nullable: false),
                        CompanyModerator_Version = c.Int(nullable: false),
                        CompanyModerator_Action = c.Int(nullable: false),
                        CompanyModerator_ModifiedById = c.Guid(nullable: false),
                        CompanyModerator_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.CompanyModerator_Id)
                .ForeignKey("dbo.AD_Companies", t => t.CompanyModerator_CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyModerator_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyModerator_ModeratedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyModerator_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanyQuestion_Title = c.String(nullable: false, maxLength: 255),
                        CompanyQuestion_Body = c.String(nullable: false, maxLength: 700),
                        ...
                        CompanyQuestion_ReportCount = c.Int(nullable: false),
                        CompanyQuestion_Version = c.Int(nullable: false),
                        CompanyQuestion_Action = c.Int(nullable: false),
                        CompanyQuestion_ModifiedById = c.Guid(nullable: false),
                        CompanyQuestion_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.CompanyQuestion_Id)
                .ForeignKey("dbo.AD_Companies", t => t.CompanyQuestion_CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyQuestion_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyQuestion_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanyQuestionLike_ReportCount = c.Int(nullable: false),
                        CompanyQuestionLike_Version = c.Int(nullable: false),
                        CompanyQuestionLike_Action = c.Int(nullable: false),
                        CompanyQuestionLike_ModifiedById = c.Guid(nullable: false),
                        CompanyQuestionLike_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.CompanyQuestionLike_Id)
                .ForeignKey("dbo.AD_Users", t => t.CompanyQuestionLike_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyQuestionLike_LikedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyQuestionLike_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanyQuestionReport_ReportCount = c.Int(nullable: false),
                        CompanyQuestionReport_Version = c.Int(nullable: false),
                        CompanyQuestionReport_Action = c.Int(nullable: false),
                        CompanyQuestionReport_ModifiedById = c.Guid(nullable: false),
                        CompanyQuestionReport_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.CompanyQuestionReport_Id)
                .ForeignKey("dbo.AD_Users", t => t.CompanyQuestionReport_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyQuestionReport_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanyReport_ReportCount = c.Int(nullable: false),
                        CompanyReport_Version = c.Int(nullable: false),
                        CompanyReport_Action = c.Int(nullable: false),
                        CompanyReport_ModifiedById = c.Guid(nullable: false),
                        CompanyReport_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.CompanyReport_Id)
                .ForeignKey("dbo.AD_Users", t => t.CompanyReport_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyReport_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanyReview_ReportCount = c.Int(nullable: false),
                        CompanyReview_Version = c.Int(nullable: false),
                        CompanyReview_Action = c.Int(nullable: false),
                        CompanyReview_ModifiedById = c.Guid(nullable: false),
                        CompanyReview_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.CompanyReview_Id)
                .ForeignKey("dbo.AD_Companies", t => t.CompanyReview_CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyReview_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyReview_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanySocial_ReportCount = c.Int(nullable: false),
                        CompanySocial_Version = c.Int(nullable: false),
                        CompanySocial_Action = c.Int(nullable: false),
                        CompanySocial_ModifiedById = c.Guid(nullable: false),
                        CompanySocial_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.CompanySocial_Id)
                .ForeignKey("dbo.AD_Companies", t => t.CompanySocial_CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanySocial_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanySocial_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CompanyVisit_ReportCount = c.Int(nullable: false),
                        CompanyVisit_Version = c.Int(nullable: false),
                        CompanyVisit_Action = c.Int(nullable: false),
                        CompanyVisit_ModifiedById = c.Guid(nullable: false),
                        CompanyVisit_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.CompanyVisit_Id)
                .ForeignKey("dbo.AD_Companies", t => t.CompanyVisit_CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyVisit_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CompanyVisit_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CategoryFollow_ReportCount = c.Int(nullable: false),
                        CategoryFollow_Version = c.Int(nullable: false),
                        CategoryFollow_Action = c.Int(nullable: false),
                        CategoryFollow_ModifiedById = c.Guid(nullable: false),
                        CategoryFollow_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.CategoryFollow_Id)
                .ForeignKey("dbo.AD_Categories", t => t.CategoryFollow_CategoryId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CategoryFollow_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CategoryFollow_FollowedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CategoryFollow_ModifiedById, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        CategoryReview_ReportCount = c.Int(nullable: false),
                        CategoryReview_Version = c.Int(nullable: false),
                        CategoryReview_Action = c.Int(nullable: false),
                        CategoryReview_ModifiedById = c.Guid(nullable: false),
                        CategoryReview_CreatedById = c.Guid(nullable: false),
                    })
                ...
                .ForeignKey("dbo.AD_Users", t => t.CategoryReview_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.CategoryReview_ModifiedById, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ProductComment_Body = c.String(nullable: false, maxLength: 500),
                        ...
                        ProductComment_ReportCount = c.Int(nullable: false),
                        ProductComment_Version = c.Int(nullable: false),
                        ProductComment_Action = c.Int(nullable: false),
                        ProductComment_ModifiedById = c.Guid(nullable: false),
                        ProductComment_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                ...
                .ForeignKey("dbo.AD_Users", t => t.ProductComment_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProductComment_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        ProductImage_ReportCount = c.Int(nullable: false),
                        ProductImage_Version = c.Int(nullable: false),
                        ProductImage_Action = c.Int(nullable: false),
                        ProductImage_ModifiedById = c.Guid(nullable: false),
                        ProductImage_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.ProductImage_Id)
                .ForeignKey("dbo.AD_Users", t => t.ProductImage_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProductImage_ModifiedById, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ProduectLike_Id = c.Guid(nullable: false),
                        ProduectLike_IsLike = c.Boolean(nullable: false),
                        ProduectLike_IsDisLike = c.Boolean(nullable: false),
                        ProduectLike_LikedById = c.Guid(nullable: false),
                        ProduectLike_ProductId = c.Guid(nullable: false),
                        ProduectLike_RowVersion = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"),
                        ProduectLike_CreatedOn = c.DateTime(nullable: false),
                        ProduectLike_ModifiedOn = c.DateTime(nullable: false),
                        ProduectLike_CreatorIp = c.String(),
                        ProduectLike_ModifierIp = c.String(),
                        ProduectLike_ModifyLocked = c.Boolean(nullable: false),
                        ProduectLike_IsDeleted = c.Boolean(nullable: false),
                        ProduectLike_ModifierAgent = c.String(),
                        ProduectLike_CreatorAgent = c.String(),
                        ProduectLike_ReportedOn = c.DateTime(),
                        ProduectLike_ReportCount = c.Int(nullable: false),
                        ProduectLike_Version = c.Int(nullable: false),
                        ProduectLike_Action = c.Int(nullable: false),
                        ProduectLike_ModifiedById = c.Guid(nullable: false),
                        ProduectLike_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.ProduectLike_Id)
                .ForeignKey("dbo.AD_Users", t => t.ProduectLike_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProduectLike_LikedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProduectLike_ModifiedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Products", t => t.ProduectLike_ProductId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.User_Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ProductProperty_Id = c.Guid(nullable: false),
                        ProductProperty_Value = c.String(nullable: false, maxLength: 100),
                        ProductProperty_ProductId = c.Guid(nullable: false),
                        ProductProperty_PropertyId = c.Guid(nullable: false),
                        ProductProperty_RowVersion = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"),
                        ProductProperty_CreatedOn = c.DateTime(nullable: false),
                        ProductProperty_ModifiedOn = c.DateTime(nullable: false),
                        ProductProperty_CreatorIp = c.String(),
                        ProductProperty_ModifierIp = c.String(),
                        ProductProperty_ModifyLocked = c.Boolean(nullable: false),
                        ProductProperty_IsDeleted = c.Boolean(nullable: false),
                        ProductProperty_ModifierAgent = c.String(),
                        ProductProperty_CreatorAgent = c.String(),
                        ProductProperty_ReportedOn = c.DateTime(),
                        ProductProperty_ReportCount = c.Int(nullable: false),
                        ProductProperty_Version = c.Int(nullable: false),
                        ProductProperty_Action = c.Int(nullable: false),
                        ProductProperty_ModifiedById = c.Guid(nullable: false),
                        ProductProperty_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.ProductProperty_Id)
                .ForeignKey("dbo.AD_Users", t => t.ProductProperty_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProductProperty_ModifiedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Products", t => t.ProductProperty_ProductId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Properties", t => t.ProductProperty_PropertyId, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Property_Title = c.String(nullable: false, maxLength: 50),
                        Property_Type = c.Int(nullable: false),
                        Property_Description = c.String(),
                        Property_Order = c.Int(nullable: false),
                        Property_CategoryId = c.Guid(nullable: false),
                        Property_RowVersion = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"),
                        Property_CreatedOn = c.DateTime(nullable: false),
                        Property_ModifiedOn = c.DateTime(nullable: false),
                        Property_CreatorIp = c.String(),
                        Property_ModifierIp = c.String(),
                        Property_ModifyLocked = c.Boolean(nullable: false),
                        Property_IsDeleted = c.Boolean(nullable: false),
                        Property_ModifierAgent = c.String(),
                        Property_CreatorAgent = c.String(),
                        Property_ReportedOn = c.DateTime(),
                        Property_ReportCount = c.Int(nullable: false),
                        Property_Version = c.Int(nullable: false),
                        Property_Action = c.Int(nullable: false),
                        Property_ModifiedById = c.Guid(nullable: false),
                        Property_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Property_Id)
                .ForeignKey("dbo.AD_Categories", t => t.Property_CategoryId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Property_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Property_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        ProductReport_ReportCount = c.Int(nullable: false),
                        ProductReport_Version = c.Int(nullable: false),
                        ProductReport_Action = c.Int(nullable: false),
                        ProductReport_ModifiedById = c.Guid(nullable: false),
                        ProductReport_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.ProductReport_Id)
                .ForeignKey("dbo.AD_Users", t => t.ProductReport_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProductReport_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        ProductShare_ReportCount = c.Int(nullable: false),
                        ProductShare_Version = c.Int(nullable: false),
                        ProductShare_Action = c.Int(nullable: false),
                        ProductShare_ModifiedById = c.Guid(nullable: false),
                        ProductShare_CreatedById = c.Guid(nullable: false),
                        Product_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.ProductShare_Id)
                .ForeignKey("dbo.AD_Users", t => t.ProductShare_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProductShare_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        ProductVisit_ReportCount = c.Int(nullable: false),
                        ProductVisit_Version = c.Int(nullable: false),
                        ProductVisit_Action = c.Int(nullable: false),
                        ProductVisit_ModifiedById = c.Guid(nullable: false),
                        ProductVisit_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.ProductVisit_Id)
                .ForeignKey("dbo.AD_Users", t => t.ProductVisit_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProductVisit_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Tag_ReportCount = c.Int(nullable: false),
                        Tag_Version = c.Int(nullable: false),
                        Tag_Action = c.Int(nullable: false),
                        Tag_ModifiedById = c.Guid(nullable: false),
                        Tag_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Tag_Id)
                .ForeignKey("dbo.AD_Users", t => t.Tag_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Tag_ModifiedById, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ProductCommentLike_ReportCount = c.Int(nullable: false),
                        ProductCommentLike_Version = c.Int(nullable: false),
                        ProductCommentLike_Action = c.Int(nullable: false),
                        ProductCommentLike_ModifiedById = c.Guid(nullable: false),
                        ProductCommentLike_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                ...
                .ForeignKey("dbo.AD_Users", t => t.ProductCommentLike_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProductCommentLike_LikedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ProductCommentLike_ModifiedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.User_Id)
                ...
                c => new
                    {
                        ...
                        UserProfile_ReportCount = c.Int(nullable: false),
                        UserProfile_Version = c.Int(nullable: false),
                        UserProfile_Action = c.Int(nullable: false),
                        UserProfile_ModifiedById = c.Guid(nullable: false),
                        UserProfile_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.UserProfile_Id)
                .ForeignKey("dbo.AD_Addresses", t => t.UserProfile_AddressId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.UserProfile_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.UserProfile_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        UserReport_ReportCount = c.Int(nullable: false),
                        UserReport_Version = c.Int(nullable: false),
                        UserReport_Action = c.Int(nullable: false),
                        UserReport_ModifiedById = c.Guid(nullable: false),
                        UserReport_CreatedById = c.Guid(nullable: false),
                        User_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.UserReport_Id)
                .ForeignKey("dbo.AD_Users", t => t.UserReport_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.UserReport_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        UserSetting_ReportCount = c.Int(nullable: false),
                        UserSetting_Version = c.Int(nullable: false),
                        UserSetting_Action = c.Int(nullable: false),
                        UserSetting_ModifiedById = c.Guid(nullable: false),
                        UserSetting_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.UserSetting_Id)
                .ForeignKey("dbo.AD_Users", t => t.UserSetting_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.UserSetting_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        UserSocial_ReportCount = c.Int(nullable: false),
                        UserSocial_Version = c.Int(nullable: false),
                        UserSocial_Action = c.Int(nullable: false),
                        UserSocial_ModifiedById = c.Guid(nullable: false),
                        UserSocial_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.UserSocial_Id)
                .ForeignKey("dbo.AD_Users", t => t.UserSocial_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.UserSocial_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Conversation_Body = c.String(nullable: false, maxLength: 2000),
                        ...
                        Conversation_SendedById = c.Guid(nullable: false),
                        ...
                        Conversation_ReportCount = c.Int(nullable: false),
                        Conversation_Version = c.Int(nullable: false),
                        Conversation_Action = c.Int(nullable: false),
                        Conversation_ModifiedById = c.Guid(nullable: false),
                        Conversation_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Conversation_Id)
                .ForeignKey("dbo.AD_Conversations", t => t.Conversation_ReplyId)
                .ForeignKey("dbo.AD_Users", t => t.Conversation_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Conversation_ModifiedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Conversation_ReceivedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Conversation_SendedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        News_Message = c.String(nullable: false, maxLength: 2000),
                        ...
                        News_ReportCount = c.Int(nullable: false),
                        News_Version = c.Int(nullable: false),
                        News_Action = c.Int(nullable: false),
                        News_ModifiedById = c.Guid(nullable: false),
                        News_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.News_Id)
                .ForeignKey("dbo.AD_Users", t => t.News_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.News_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Notification_ReportCount = c.Int(nullable: false),
                        Notification_Version = c.Int(nullable: false),
                        Notification_Action = c.Int(nullable: false),
                        Notification_ModifiedById = c.Guid(nullable: false),
                        Notification_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Notification_Id)
                .ForeignKey("dbo.AD_Users", t => t.Notification_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Notification_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Payment_ReportCount = c.Int(nullable: false),
                        Payment_Version = c.Int(nullable: false),
                        Payment_Action = c.Int(nullable: false),
                        Payment_ModifiedById = c.Guid(nullable: false),
                        Payment_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Payment_Id)
                .ForeignKey("dbo.AD_Users", t => t.Payment_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Payment_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        PaymentTransaction_ReportCount = c.Int(nullable: false),
                        PaymentTransaction_Version = c.Int(nullable: false),
                        PaymentTransaction_Action = c.Int(nullable: false),
                        PaymentTransaction_ModifiedById = c.Guid(nullable: false),
                        PaymentTransaction_CreatedById = c.Guid(nullable: false),
                        Payment_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.PaymentTransaction_Id)
                .ForeignKey("dbo.AD_UserBudgets", t => t.PaymentTransaction_BudgetId, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.PaymentTransaction_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.PaymentTransaction_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Statistic_ReportCount = c.Int(nullable: false),
                        Statistic_Version = c.Int(nullable: false),
                        Statistic_Action = c.Int(nullable: false),
                        Statistic_ModifiedById = c.Guid(nullable: false),
                        Statistic_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Statistic_Id)
                .ForeignKey("dbo.AD_Users", t => t.Statistic_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.Statistic_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        ActivityLog_ReportCount = c.Int(nullable: false),
                        ActivityLog_Version = c.Int(nullable: false),
                        ActivityLog_Action = c.Int(nullable: false),
                        ActivityLog_ModifiedById = c.Guid(nullable: false),
                        ActivityLog_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.ActivityLog_Id)
                .ForeignKey("dbo.AD_Users", t => t.ActivityLog_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.ActivityLog_ModifiedById, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        AuditLog_ReportCount = c.Int(nullable: false),
                        AuditLog_Version = c.Int(nullable: false),
                        AuditLog_Action = c.Int(nullable: false),
                        AuditLog_ModifiedById = c.Guid(nullable: false),
                        AuditLog_CreatedById = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.AuditLog_Id)
                .ForeignKey("dbo.AD_Users", t => t.AuditLog_CreatedById, cascadeDelete: true)
                .ForeignKey("dbo.AD_Users", t => t.AuditLog_ModifiedById, cascadeDelete: true)

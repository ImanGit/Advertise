        ...
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                {
                    ...
                    User_IsDeleted = c.Boolean(false),
                    User_IsActive = c.Boolean(false),
                    User_Gender = c.Int(false),
                    User_CityId = c.Guid(false),
                    User_RowVersion = c.Binary(false, fixedLength: true, timestamp: true, storeType: "rowversion")
                })
                .PrimaryKey(t => t.User_Id)
                .ForeignKey("dbo.AD_Cities", t => t.User_CityId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    Account_Id = c.Guid(false),
                    Account_Email = c.String(),
                    Account_MobileNumber = c.String(),
                    Account_Password = c.String(),
                    Account_CreateDate = c.DateTime(false),
                    Account_UserName = c.String(),
                    Account_LastLoginDate = c.DateTime(false),
                    Account_IsBanned = c.Boolean(false),
                    Account_IsVerified = c.Boolean(false),
                    Account_IsActive = c.Boolean(false),
                    Account_IsEmailConfirmed = c.Boolean(false),
                    Account_IsMobileConfirmed = c.Boolean(false),
                    Account_IsGuested = c.Boolean(false),
                    Account_RoleId = c.Guid(false),
                    Account_UserId = c.Guid(false),
                    Account_RowVersion = c.Binary()
                })
                .PrimaryKey(t => t.Account_Id)
                .ForeignKey("dbo.AD_Roles", t => t.Account_RoleId, true)
                .ForeignKey("dbo.AD_Users", t => t.Account_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    Budget_Id = c.Guid(false),
                    Budget_RemainValue = c.Int(false),
                    Budget_IncDecValue = c.Int(false),
                    Budget_ReffrenceCode = c.String(),
                    Budget_CreateDate = c.DateTime(false),
                    Budget_UserId = c.Guid(false),
                    Budget_RowVersion = c.Binary()
                })
                .PrimaryKey(t => t.Budget_Id)
                .ForeignKey("dbo.AD_Users", t => t.Budget_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    City_CityName = c.String(false, 100),
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Product_CreateDate = c.DateTime(false),
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Company_UserId = c.Guid(false),
                    Company_CityId = c.Guid(false),
                    Company_RowVersion = c.Binary()
                })
                .PrimaryKey(t => t.Company_Id)
                .ForeignKey("dbo.AD_Cities", t => t.Company_CityId, true)
                .ForeignKey("dbo.AD_Users", t => t.Company_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    Comment_Id = c.Guid(false),
                    Comment_Content = c.String(false, 500),
                    Comment_CreateDate = c.DateTime(false),
                    Comment_LikedCount = c.Int(),
                    Comment_IsAccepted = c.Boolean(false),
                    Comment_CreateUserId = c.Guid(false),
                    Comment_ProductId = c.Guid(false),
                    Comment_AcceptUserId = c.Guid(false),
                    Comment_RowVersion = c.Binary(false, fixedLength: true, timestamp: true, storeType: "rowversion")
                })
                .PrimaryKey(t => t.Comment_Id)
                .ForeignKey("dbo.AD_Users", t => t.Comment_AcceptUserId, true)
                .ForeignKey("dbo.AD_Products", t => t.Comment_ProductId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    Follow_Id = c.Guid(false),
                    Follow_RegisterDate = c.DateTime(false),
                    Follow_Type = c.Int(false),
                    Follow_UserId = c.Guid(false),
                    Follow_CategoryId = c.Guid(false),
                    Follow_CompanyId = c.Guid(false),
                    Follow_RowVersion = c.Binary()
                })
                .PrimaryKey(t => t.Follow_Id)
                .ForeignKey("dbo.AD_Categories", t => t.Follow_CategoryId, true)
                .ForeignKey("dbo.AD_Companies", t => t.Follow_CompanyId, true)
                .ForeignKey("dbo.AD_Users", t => t.Follow_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    Like_Id = c.Guid(false),
                    Like_Type = c.Int(false),
                    Like_RegisterDate = c.DateTime(false),
                    Like_UserId = c.Guid(false),
                    Like_CommentId = c.Guid(false),
                    Like_ProductId = c.Guid(false),
                    Like_RowVersion = c.Binary()
                })
                .PrimaryKey(t => t.Like_Id)
                .ForeignKey("dbo.AD_Comments", t => t.Like_CommentId, true)
                .ForeignKey("dbo.AD_Products", t => t.Like_ProductId, true)
                .ForeignKey("dbo.AD_Users", t => t.Like_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Log_Action = c.String(),
                    Log_LogLevel = c.Int(false),
                    Log_Date = c.DateTime(false),
                    Log_UserId = c.Guid(false),
                    Log_RowVersion = c.Binary()
                })
                .PrimaryKey(t => t.Log_Id)
                .ForeignKey("dbo.AD_Users", t => t.Log_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    Message_Id = c.Guid(false),
                    Message_Title = c.String(),
                    Message_Content = c.String(),
                    Message_IsViewed = c.Boolean(false),
                    Message_FromUserId = c.Guid(false),
                    Message_ToUserId = c.Guid(false),
                    Message_ReplyId = c.Guid(false),
                    Message_RowVersion = c.Binary()
                })
                .PrimaryKey(t => t.Message_Id)
                .ForeignKey("dbo.AD_Users", t => t.Message_FromUserId, true)
                .ForeignKey("dbo.AD_Messages", t => t.Message_ReplyId)
                .ForeignKey("dbo.AD_Users", t => t.Message_ToUserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    Notice_Id = c.Guid(false),
                    Notice_Title = c.String(),
                    Notice_Content = c.String(),
                    Notice_CreateDate = c.DateTime(false),
                    Notice_IsVisible = c.Boolean(false),
                    Notice_UserId = c.Guid(false),
                    Notice_RowVersion = c.Binary()
                })
                .PrimaryKey(t => t.Notice_Id)
                .ForeignKey("dbo.AD_Users", t => t.Notice_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Notification_IsViewed = c.Boolean(false),
                    Notification_CreateDate = c.DateTime(false),
                    Notification_UserId = c.Guid(false),
                    Notification_ProductId = c.Guid(false),
                    Notification_RowVersion = c.Binary()
                })
                .PrimaryKey(t => t.Notification_Id)
                .ForeignKey("dbo.AD_Products", t => t.Notification_ProductId, true)
                .ForeignKey("dbo.AD_Users", t => t.Notification_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Payment_CreateDate = c.DateTime(false),
                    Payment_FromDate = c.DateTime(false),
                    Payment_ToDate = c.DateTime(false),
                    Payment_PlanId = c.Guid(false),
                    Payment_UserId = c.Guid(false),
                    Payment_BudgetId = c.Guid(false),
                    Payment_RowVersion = c.Binary(false, fixedLength: true, timestamp: true, storeType: "rowversion")
                })
                .PrimaryKey(t => t.Payment_Id)
                .ForeignKey("dbo.AD_Budgets", t => t.Payment_BudgetId, true)
                .ForeignKey("dbo.AD_Plans", t => t.Payment_PlanId, true)
                .ForeignKey("dbo.AD_Users", t => t.Payment_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    Plan_Id = c.Guid(false),
                    Plan_Code = c.String(false, 50),
                    Plan_Title = c.String(false, 100),
                    Plan_Description = c.String(maxLength: 250),
                    Plan_DurationDay = c.String(false),
                    Plan_CostValue = c.Int(false),
                    Plan_IsEnabled = c.Boolean(false),
                    Plan_FromDate = c.DateTime(false),
                    Plan_ToDate = c.DateTime(false),
                    Plan_RowVersion = c.Binary(false, fixedLength: true, timestamp: true, storeType: "rowversion")
                })
            ...
            CreateTable(
                ...
                c => new
                {
                    Question_Id = c.Guid(false),
                    Question_Title = c.String(false, 255),
                    Question_Content = c.String(false, 700),
                    Question_CreateDate = c.DateTime(false),
                    Question_LikedCount = c.Int(),
                    Question_IsAccepted = c.Boolean(false),
                    Question_ReplyId = c.Guid(false),
                    Question_CompanyId = c.Guid(false),
                    Question_UserId = c.Guid(false),
                    Question_RowVersion = c.Binary(false, fixedLength: true, timestamp: true, storeType: "rowversion")
                })
                .PrimaryKey(t => t.Question_Id)
                .ForeignKey("dbo.AD_Companies", t => t.Question_CompanyId, true)
                .ForeignKey("dbo.AD_Questions", t => t.Question_ReplyId)
                .ForeignKey("dbo.AD_Users", t => t.Question_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    Setting_Id = c.Guid(false),
                    Setting_Language = c.Int(),
                    Setting_Theme = c.Int(),
                    Setting_UserId = c.Guid(false),
                    Setting_RowVersion = c.Binary(false, fixedLength: true, timestamp: true, storeType: "rowversion")
                })
                .PrimaryKey(t => t.Setting_Id)
                .ForeignKey("dbo.AD_Users", t => t.Setting_UserId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Property_Value = c.String(false, 100),
                    Property_ProductId = c.Guid(false),
                    Property_PropertyTemplateId = c.Guid(false),
                    Property_RowVersion = c.Binary(false, fixedLength: true, timestamp: true, storeType: "rowversion")
                })
                .PrimaryKey(t => t.Property_Id)
                .ForeignKey("dbo.AD_Products", t => t.Property_ProductId, true)
                .ForeignKey("dbo.AD_PropertyTemplates", t => t.Property_PropertyTemplateId, true)
            ...
            CreateTable(
                ...
                c => new
                {
                    PropertyTemplate_Id = c.Guid(false),
                    PropertyTemplate_Title = c.String(false, 50),
                    PropertyTemplate_Property = c.Int(false),
                    PropertyTemplate_RowVersion =
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Social_CompanyId = c.Guid(false),
                    Social_RowVersion = c.Binary(false, fixedLength: true, timestamp: true, storeType: "rowversion")
                })
                .PrimaryKey(t => t.Social_Id)
                .ForeignKey("dbo.AD_Companies", t => t.Social_CompanyId, true)
